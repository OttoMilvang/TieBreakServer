...
def bergertables(nplayers):
    ...
    for rnd in range(2, nplayers):
        ...
        for board in range(2, pairs):
            newpairing[board] = {
                "white": pairing[pairs - board + 1]["black"],
                "black": pairing[pairs - board + 2]["white"],
            }
...
def bergertablesGeneric(nplayers):
    ...
    for rnd in range(2, nplayers):
        ...
        # We don't longer need pairing for the previous round. Reuse for this round
        pairing = {}
        # On the first board player N shall meet the last player in a sorted list.
