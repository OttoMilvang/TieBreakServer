...
def test_240_naming_a_player_who_exists_is_read():
    ...
    assert [(chessfile.get_result_cid(game, "white"), chessfile.get_result_cid(game, "black"), game["wResult"]) for game in byes] == [(3, 0, "D")]
...
def test_240_names_a_team_in_a_team_tournament():
    ...
    assert [(chessfile.get_result_cid(match, "white"), chessfile.get_result_cid(match, "black"), match["wResult"]) for match in byes] == [(3, 0, "D")]
